...
export default function AIPage() {
  ...
  const [messages,  setMessages]  = useState([{
    role: "assistant",
    content: "Hello! I'm your Gemini-powered compliance assistant. Ask me anything about GST, TDS, ROC, MCA, Income Tax, penalties, or your client deadlines. 🙏"
  }]);
    ...
    <AppShell>
      <div className="animate-fadeUp" style={{ height:"calc(100vh - 120px)", display:"flex", flexDirection:"column" }}>
        ...
        <div style={{ marginBottom:20, display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <div>
            <h1 style={{ fontFamily:"DM Serif Display,serif", fontSize:28, fontWeight:400 }}>AI Assistant</h1>
            <p style={{ color:"var(--muted)", fontSize:12, marginTop:4 }}>Powered by Gemini · Indian tax & compliance expert</p>
          </div>
          <div style={{ display:"flex", alignItems:"center", gap:8, padding:"6px 14px", borderRadius:8, background:"rgba(126,186,90,0.08)", border:"1px solid rgba(126,186,90,0.25)" }}>
            ...
            <span style={{ fontSize:11, color:"var(--accent)", fontFamily:"JetBrains Mono,monospace" }}>GEMINI CONNECTED</span>
          </div>
        </div>
